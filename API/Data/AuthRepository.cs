...
namespace API.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public AuthRepository(APIDBContext context, IConfiguration configuration)
        {
        ...
        private string CreateToken(User user)
        {
            ...
            SymmetricSecurityKey key = new SymmetricSecurityKey(Encoding.UTF8
                //.GetBytes("mytopsecretkeymytopsecretkeymytopsecretkeymytopsecretk435345eymytopsecretkeymytopsecretkeymytopsecretkey"));
